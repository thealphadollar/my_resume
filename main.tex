...
\hfill GPA & \textbf{8.66}/10.0 (Ongoing)\\
...
\textsc{Aug '21}& {- Worked under Master team responsible for migration of monolith Mercari HTTP architecture into gRPC micro-services to optimize load-cost, decouple independent services, and increase maintainability.}\\
