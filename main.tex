...
\textsc{Ongoing}& {- Designed process for migration of the monolith Mercari HTTP APIs (PHP) serving transaction data into gRPC micro-service (Golang) to optimize load-cost, decouple independent services, and increase maintainability.}\\
& {- Designed \& developed i18n microservices-kit's middle-ware, reduced engineering hours for client-config updates to 0 from 4hrs/week and refactored the microservices' code to improve extensibility.}\\
& {- In line with OpenSource culture, improved org-wide documentation for QA, release processes, and decommissioning micro-services; optimizing costs and improving production-release speed and security. }\\[2mm]
