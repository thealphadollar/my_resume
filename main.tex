...
\textsc{Libraries / Frameworks} & Node.js | JQuery | OpenCV | Flask | Jekyll | Numpy | Pandas | Scipy | CoffeeScript\\
\textsc{Databases} & SQLite | MongoDB \\
\textsc{Systems / Platforms} & Git | Docker | Linux | Bash | Web Servers\\
