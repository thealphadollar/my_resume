...
\textsc{Programming Languages} & C | C++ | JavaScript | Golang | Python  \\
\textsc{Libraries / Frameworks} & Node.js | OpenCV | Numpy | Pandas | Scipy | CoffeeScript\\
\textsc{Databases} & SQLite | MongoDB | PostgreSQL | MySQL \\
\textsc{Systems / Platforms} & Git | Docker | Linux | Heroku | Microsoft Azure | Vagrant\\
...
& {- Improved data synchronization accuracy between front-end and data layer.}\\
